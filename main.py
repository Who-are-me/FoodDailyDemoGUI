...
class Widget(QWidget):
    ...
    def get_classes_with_calories(self, name='csv_data/calories.csv'):
    ...
    def slot_start_ai(self):
        if self.ui.cb_use_calories_classes.isChecked():
            dict_classes, dict_classes_calories = self.get_classes_with_calories()
